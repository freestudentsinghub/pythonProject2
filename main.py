from src.processing import sorted_by_datetime, filter_by_state
        ...
        if status in ['EXECUTED', 'CANCELED', 'PENDING']:
            ...
            if user_input_data == 'Да':
                ...
                if user_input_ascending == 'по возрастанию':
                    list_transactions = sorted_by_datetime(list_transactions, 'ascending')
                else:
                    list_transactions = sorted_by_datetime(list_transactions, "descending")
